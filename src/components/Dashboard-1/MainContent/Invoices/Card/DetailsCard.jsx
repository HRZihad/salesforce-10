            ...
            <DatePicker
              sx={{
                ...
                "&:hover .MuiOutlinedInput-notchedOutline": {
                  borderColor: theme.palette.icon.iconBg, // Remove border color on hover
                },
      ...
      <Box className=" flex items-center justify-center">
        ...
        >
          <Box className="flex w-full">
            <Box className="hidden lg:block md:flex-2 bg-white lg:w-[29%] xl:w-[33.5%] 2xl:w-[39.5%]">
              <Box
            ...
            <Box className="flex-[1.5] py-2 xl:pt-0 lg:w-[41%] xl:w-[33%] 2xl:w-[21%] bg-white lg:rounded-bl-[30px] md:rounded-br-[30px]">
              <Box className=" flex items-center justify-center">
            ...
            <Box className="hidden md:block flex-2 bg-white lg:w-[29%] xl:w-[33.5%] 2xl:w-[39.5%]">
              <Box
