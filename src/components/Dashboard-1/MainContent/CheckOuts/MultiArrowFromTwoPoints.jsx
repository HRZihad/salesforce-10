    ...
    <Box className=" grid grid-cols-1 xl:grid-cols-2 xxl:grid-cols-4 gap-10 mt-4 bg-[#DBE5F2] py-5 px-4">
      ...
      >
        <Box style={outsideParentStyle}>
          ...
          <Box className="flex flex-col h-full">
            ...
            >
              <Box id="elementOutside1" className="flex items-center justify-between cursor-move">
              ...
              <Box id="elementOutside2" className="flex items-center justify-between cursor-move">
      ...
      >
        <Box style={parentStyle}>
          <Box className="flex flex-col h-full">
            ...
            >
              <Box id="child1" className="flex items-center justify-between cursor-move">
                {/* Circle */}
              ...
              <Box id="child2" className="flex items-center justify-between cursor-move">
                {/* Circle */}
                <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
                <Box className=" px-6 py-4 w-[100%]">
                  <Box className=" flex items-center justify-between ">
              ...
              <Box id="child3" className="flex items-center justify-between cursor-move">
                {/* circle */}
                <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
                {/* Content of box 2 */}
                <Box className=" px-6 py-4 w-[100%]">
              ...
              <Box id="child4" className="flex items-center justify-between cursor-move">
                {/* Circle */}
                <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
                {/* Content of box 2 */}
              ...
              <Box id="child5" className="flex items-center justify-between cursor-move">
                {/* Circle */}
                <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
                {/* Content of box 2 */}
                <Box className=" px-6 py-4">
      ...
      >
        ...
        <Box className="flex flex-col h-full cursor-move">
          ...
          >
            {/* 3rd box content  */}
            <Box id="child6" className="flex items-center justify-between cursor-move">
              {/* Circle */}
              <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
              {/* 3rd box content */}
            ...
            {/* 3rd box content  */}
            <Box id="child7" className="flex items-center justify-between cursor-move">
              {/* Circle */}
              <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
              {/* 3rd box content */}
              <Box className=" flex items-center gap-x-2 w-[80%]">
            ...
            {/* 3rd box content  */}
            <Box id="child8" className="flex items-center justify-between cursor-move">
              {/* Circle */}
              <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
            ...
            {/* 3rd box content  */}
            <Box id="child9" className="flex items-center justify-between cursor-move">
              {/* Circle */}
              <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
              {/* 3rd box content with avatar  */}
              <Box className=" flex items-center gap-x-2 w-[80%]">
            ...
            {/* 3rd box content  */}
            <Box id="child10" className="flex items-center justify-between cursor-move">
              {/* Circle */}
              <Box className="h-4 w-4 bg-[#DBE5F2] rounded-full flex items-center justify-center -ml-2"></Box>
              {/* 3rd box content  */}
              <Box className=" flex items-center gap-x-2 w-[80%]">
